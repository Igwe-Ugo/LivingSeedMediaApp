...
import 'package:livingseed_media/screens/pages/services/about_book_services.dart';
import 'package:livingseed_media/screens/pages/services/bible_study_services.dart';
import 'package:livingseed_media/screens/pages/services/magazine_services.dart';
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        style:
                            ButtonStyle(elevation: WidgetStatePropertyAll(0)),
                        onPressed: () => GoRouter.of(context).go(
                            '${LivingSeedAppRouter.accountPath}/${LivingSeedAppRouter.dashboardPath}/${LivingSeedAppRouter.addEventPath}'),
